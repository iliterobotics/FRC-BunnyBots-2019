...
public class NeoDriveHardware implements IDriveHardware {
    ...
    private final CANSparkMax mLeftMaster, mRightMaster;
    ...
    public void zero() {
        ...
        setNeutralMode(CANSparkMax.IdleMode.kBrake, mLeftMaster);
        setNeutralMode(CANSparkMax.IdleMode.kBrake, mRightMaster);
    ...
    public void set(DriveMessage pDriveMessage) {
        ...
        mLeftNeutralMode = configForNeutralMode(mLeftNeutralMode, pDriveMessage.leftNeutralMode.kRevIdleMode, mLeftMaster);
        mRightNeutralMode = configForNeutralMode(mRightNeutralMode, pDriveMessage.rightNeutralMode.kRevIdleMode, mRightMaster);
