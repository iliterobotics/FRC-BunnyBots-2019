...
public class NeoDriveHardware implements IDriveHardware {
    ...
    private final CANSparkMax mLeftMaster, mRightMaster, mLeftRear, mRightRear, mLeftMiddle, mRightMiddle;
    ...
    public void zero() {
        ...
        setNeutralMode(CANSparkMax.IdleMode.kBrake, mLeftMaster, mLeftRear , mLeftMiddle);
        setNeutralMode(CANSparkMax.IdleMode.kBrake, mRightMaster, mRightRear , mRightMiddle);
    ...
    public void set(DriveMessage pDriveMessage) {
        ...
        mLeftNeutralMode = configForNeutralMode(mLeftNeutralMode, pDriveMessage.leftNeutralMode.kRevIdleMode, mLeftMaster, mLeftRear , mLeftMiddle);
        mRightNeutralMode = configForNeutralMode(mRightNeutralMode, pDriveMessage.rightNeutralMode.kRevIdleMode, mRightMaster, mRightRear , mRightMiddle);
