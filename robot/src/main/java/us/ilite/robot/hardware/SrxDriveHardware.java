...
public class SrxDriveHardware implements IDriveHardware {
    ...
    public SrxDriveHardware() {
        ...
        mLeftMaster = TalonSRXFactory.createDefaultTalon(SystemSettings.kPracticeDriveLeftTalonID);
        mRightMaster = TalonSRXFactory.createDefaultTalon(SystemSettings.kPracticeDriveRightTalonID);
